package com.li.xiaomi.xiaomi_core.utils.glideUtils;
...
public class GlidePicUtils {
    ...
    public static void LoadImg(Context mContext, ImageView imageView, String url) {
            ...
            GlideApp.with(mContext)
                    ...
                    .fallback(R.drawable.testpic)//当url为空时，显示图片
                    .into(imageView);
    }
    ...
    public static void LoadImgByFile(Context mContext, ImageView imageView, File mFile) {
        GlideApp.with(mContext).asBitmap()
                .load(mFile)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .preload();
